...
static void decision_write_datasegment_struct(uint16_t cmd_id)
{
    switch (cmd_id)
    {
        ...
        break;
        case 0x0205:
            write_data_from_buffer_to_uion(decision_all_data._aerial_robot_energy.usart_data,3);
        break;
        case 0x0206:
            write_data_from_buffer_to_uion(decision_all_data._robot_hurt.usart_data,1);
        break;
        case 0x0207:
            write_data_from_buffer_to_uion(decision_all_data._shoot_data.usart_data,6);
        break;
        case 0x0208:
            write_data_from_buffer_to_uion(decision_all_data._bullet_remaining.usart_data,2);
        break;
        case 0x0209:
